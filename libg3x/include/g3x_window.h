/* ===============================================================
  ...
  /*  les 3 coord. sphériques + point de visée */  
  void g3x_SetLightSpheric(double theta, double phi, double dist, G3Xpoint target);
  /*  même chose en cartésien */
  void g3x_SetLightCartesian(G3Xpoint position, G3Xpoint target) ;
