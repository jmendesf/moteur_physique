...
extern bool g3x_PnmRead(G3Xpnm** img, char* filename, bool MPEG_SETUP)
{
...
extern bool g3x_ImageRead(G3Xpnm** img, char *filename, bool MPEG_SETUP, bool RELOAD)
{
...
extern bool g3x_PnmWrite(G3Xpnm* img, char* filename, char mode, char* comment)
{
  FILE  *imgfile;
